Feature: Payment with paypal feature

  Scenario: As a valid user I can log into my app and make a purchase through paypal
    ...
    Then I should be able to choose the payment method as paypal
